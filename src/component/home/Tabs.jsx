                            ...
                            <div className='tab_div_main'>
                                <div className='report-details mainParentSeachBox'>
                                    ...
                                    <div className="search-input">
                                        ...
                                        />
                                        <Button variant="contained" color="success" className='searchButton mainButton mx-2' onClick={() => handleSearch(searchData)}>Search</Button>
                                    </div>
                                </div>
                            ...
                            <div className='tab_div_main'>
                                <div className='report-details mainParentSeachBox'>
                                    ...
                                    <div className="search-input">
                                        ...
                                        />
                                        <Button variant="contained" color="success" className='searchButton mainButton mx-2' onClick={() => handleSearch2(searchData2)}>Search</Button>
                                    </div>
                                </div>
                                <div className="user-details">
                                    {searchResult === "screen" ? (
                            ...
                            <div className='tab_div_main'>
                                <div className='report-details mainParentSeachBox'>
                                    ...
                                    <div className="search-input">
                                        ...
                                        />
                                        <Button variant="contained" color="success" className='searchButton mainButton mx-2' onClick={() => handleSearch3(searchData3)}>Search</Button>
                                    </div>
                                </div>
                                <div className="user-details">
                                    {searchResult === "screen" ? (
